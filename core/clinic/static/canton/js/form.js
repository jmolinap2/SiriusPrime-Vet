                        ...
                        remote: {
                            ...
                            data: function () {
                                return {
                                    ...
                                    province: fv.form.querySelector('[name="province"]').value,
                                    action: 'validate_data'
                                };
                            },
                            message: 'El nombre del cantón ya se encuentra registrado',
                            method: 'POST',
                            headers: {
...
$(function () {
    ...
    $('select[name="province"]').on('change.select2', function () {
