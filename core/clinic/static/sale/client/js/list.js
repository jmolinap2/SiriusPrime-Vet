            ...
            columnDefs: [
                ...
                },
                {
                    ...
                    render: function (data, type, row) {
                        ...
                        if (row.status.id === 'active' && row.type.id === 'quote') {
                            buttons += ' <a class="btn btn-danger btn-xs btn-flat" rel="cancel" data-toggle="tooltip" title="Cancelar"><i class="fas fa-times"></i></a>';
                        }
                        return buttons;
                    }
                },
...
$(function () {
    ...
    $('#data tbody')
        ...
        .on('click', 'a[rel="cancel"]', function () {
            ...
            params.append('action', 'cancel_quote');
            params.append('id', row.id);
            var args = {
                'content': '¿Estas seguro de cancelar la cita médica?',
                'params': params,
