                        ...
                        remote: {
                            ...
                            data: function () {
                                return {
                                    ...
                                    canton: fv.form.querySelector('[name="canton"]').value,
                                    action: 'validate_data'
                                };
                            },
                            message: 'El nombre de la parroquia ya se encuentra registrado',
                            method: 'POST',
                            headers: {
...
$(function () {
    ...
    select_canton = $('select[name="canton"]');
